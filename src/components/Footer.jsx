          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Your trusted partner in IELTS preparation. We help students worldwide 
                achieve their target band scores with expert guidance and cutting-edge technology.
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">info@ieltsinstitute.com</span>
                </div>
                <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-300 mb-6">
              Get the latest IELTS tips, study materials, and course updates delivered to your inbox.
            </p>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} IELTS Institute. All rights reserved.
            </div>
